...
export const ADD_USER_FAILED = {"error": "add_user_failed", "error_description": "adding user failed"};
export const EDIT_USER_FAILED = {"error": "edit_user_failed", "error_description": "editing user failed"};
